...
매 수업용 10분 분량 슬라이드 모음. 영어코딩의 모든 텍스트 기반 코스용. 1:1 정사각 포맷. 큰 글씨. 움직이는 시각 자료. ESL(영어 학습자) 친화.
...
| 🗣️ **영어 토론** | DB001 테크 & AI 토론 (16주차) | ✅ 완료 |

각 코스 = 8주 차 수업 (DB001만 16주차). 한 주차 = 한 슬라이드 덱.

DB001은 코딩 코스와 슬롯 구조가 달라요. 코드가 없는 대신 주제·기술·문장 형식·모범 발언·타이머·양쪽 주장 자료로 구성됩니다. 생성 스크립트: `scripts/build-debate-decks.py`
